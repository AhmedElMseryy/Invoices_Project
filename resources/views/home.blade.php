...
$partpaid = invoices::where('Value_Status', 3)->get();
?>
                        ...
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    {{ number_format(invoices::sum('Total'), 2) }}</h4>
                ...
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    {{ number_format($unpaid->sum('Total'), 2) }}</h4>
                                <p class="mb-0 tx-12 text-white op-7">{{ invoices::where('Value_Status', 2)->count() }}</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-down text-white"></i>
                                <span class="text-white op-7">
                                    {{ (invoices::where('Value_Status', 2)->count() / invoices::count()) * 100 }}%</span>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    {{ number_format($paid->sum('Total'), 2) }}</h4>
                                <p class="mb-0 tx-12 text-white op-7">{{ invoices::where('Value_Status', 1)->count() }}</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-up text-white"></i>
                                <span class="text-white op-7">
                                    {{ (invoices::where('Value_Status', 1)->count() / invoices::count()) * 100 }}%</span>
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    {{ number_format($partpaid->sum('Total'), 2) }}</h4>
                                <p class="mb-0 tx-12 text-white op-7">{{ invoices::where('Value_Status', 3)->count() }}</p>
                            </div>
                            <span class="float-right my-auto mr-auto">
                                <i class="fas fa-arrow-circle-down text-white"></i>
                                <span class="text-white op-7">
                                    {{ (invoices::where('Value_Status', 3)->count() / invoices::count()) * 100 }}%</span>
                            </span>
                        </div>
                    </div>
                </div>
